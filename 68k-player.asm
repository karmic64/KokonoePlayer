...
AMT_SONG_SLOTS = 3
AMT_SONG_SLOT_TRACKS = 13

AMT_TRACKS = AMT_SONG_SLOTS*AMT_SONG_SLOT_TRACKS
...
kn_track_song_slot_index_tbl:
	rept AMT_SONG_SLOTS
		dcb.w AMT_SONG_SLOT_TRACKS, ss_size*REPTN + k_song_slots
	endr

kn_song_slot_track_index_tbl:
	rept AMT_SONG_SLOTS
		dw t_size*REPTN*AMT_SONG_SLOT_TRACKS + k_tracks
	endr
	
kn_song_slot_size_tbl:
	dcb.b AMT_SONG_SLOTS,AMT_SONG_SLOT_TRACKS
	align 1
