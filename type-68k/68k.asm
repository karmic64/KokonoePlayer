...
KN_TRACKS = KN_SONG_SLOTS*KN_SONG_SLOT_TRACKS
...
k_song_slots so.b ss_size*KN_SONG_SLOTS

k_tracks so.b t_size*KN_TRACKS



k_chn_track so.b KN_CHANNELS
...
kn_track_song_slot_index_tbl:
	rept KN_SONG_SLOTS
		dcb.w KN_SONG_SLOT_TRACKS, ss_size*REPTN + k_song_slots
	endr

kn_song_slot_track_index_tbl:
	rept KN_SONG_SLOTS
		dw t_size*REPTN*KN_SONG_SLOT_TRACKS + k_tracks
	endr
	
kn_song_slot_size_tbl:
	dcb.b KN_SONG_SLOTS,KN_SONG_SLOT_TRACKS
	align 1
